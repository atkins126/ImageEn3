...
We suggest to use <A TImageEnView>.<A TImageEnView.IO>.<A TImageEnIO.DShowParams> in order to capture video from cameras, because this one uses the more supported DirectShow API.
