...
function ZCompressStr(const s: AnsiString; level: TZCompressionLevel): AnsiString; // level: TZCompressionLevel = zcDefault
  ...
  try
    ...
    try
      ...
      begin
        ...
        zstream.next_out := PAnsiChar(int64(DWORD(outBuffer)) + zstream.total_out);
