...
begin
  ...
  begin
    ...
    begin
      ...
      else if Code < 256 then // just an optimization
      begin
...
begin
  ...
  begin
    ...
    dec(CountDown);
    result := pbyte(int64(DWORD(indata)) + inpos)^;
    inc(inpos);
  end;
end;
...
begin
  ...
  i := hsize - 16;
  repeat
    pinteger(int64(DWORD(htab_p)) - 4 * 16)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 15)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 14)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 13)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 12)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 11)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 10)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 9)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 8)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 7)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 6)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 5)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 4)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 3)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 2)^ := m1;
    pinteger(int64(DWORD(htab_p)) - 4 * 1)^ := m1;
    dec(htab_p, 16);
    dec(i, 16);
  until not (i >= 0);
  inc(i, 16);
