...
begin
  ...
  *)
  ...
  begin
    ...
    label4.caption := string( IEIntToStr(idim) + ' bytes' );
  ...
  begin
    ...
    Label74.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
...
{$IFDEF IEINCLUDEJPEG2000}
    ...
    label68.caption := string( IEIntToStr(idim) + ' bytes' );
{$ENDIF}
  end;
  ...
  begin
    ...
    label11.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  ...
  begin
    ...
    Label78.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  ...
  begin
    ...
    label28.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  if (PageControl1.ActivePage = TabSheetGIF2) then
  begin
    // GIF-simplified
    combobox18.itemindex := GIF_BitsPerSample - 1;
    Label84.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  ...
  begin
    ...
    label40.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  ...
  begin
    ...
    label46.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  ...
  begin
    ...
    label51.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  ...
  begin
    ...
    label59.caption := string( IEIntToStr(idim) + ' bytes' );
  end;
  //
  dochange := true;
end;
...
begin
  ...
  begin
    ...
    label25.caption := string( IEIntToStr(mf.size) + ' bytes' );
    label76.caption := string( IEIntToStr(mf.size) + ' bytes' );
    mf.position := 0;
    xper := 50;
...
{$IFDEF IEINCLUDEJPEG2000}
    ...
    Label70.caption := string( IEIntToStr(mf.size) + ' bytes' );
    mf.position := 0;
    xper := 50;
...
{$ENDIF}
  ...
  begin
    ...
    label18.caption := string( IEIntToStr(ns.size) + ' bytes' );
    Label80.caption := string( IEIntToStr(ns.size) + ' bytes' );
    try
  ...
  begin
    ...
    label30.caption := string( IEIntToStr(ns.size) + ' bytes' );
    Label86.caption := string( IEIntToStr(ns.size) + ' bytes' );
    try
    imageen2.Assign( imageen1 );
    except
      Caption:='Result can not be shown but parameters may be entered';
  ...
  begin
    ...
    begin
      ...
      SaveToStreamBMP(ns);
      label42.caption := string( IEIntToStr(ns.size) + ' bytes' );
      try
      imageen2.assign( imageen1 );
      except
        Caption:='Result can not be shown but parameters may be entered';
  ...
  begin
    ...
    begin
      ...
      SaveToStreamPCX(ns);
      label48.caption := string( IEIntToStr(ns.size) + ' bytes' );
      try
      imageen2.assign( imageen1 );
      except
        Caption:='Result can not be shown but parameters may be entered';
...
{$IFDEF IEINCLUDEPNG}
    ...
    begin
      ...
      SaveToStreamPNG(ns);
      Label53.caption := string( IEIntToStr(ns.size) + ' bytes' );
      try
      imageen2.assign( imageen1 );
      except
        Caption:='Result can not be shown but parameters may be entered';
...
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      SaveToStreamTGA(ns);
      Label61.caption := string( IEIntToStr(ns.size) + ' bytes' );
      try
      imageen2.assign( imageen1 );
      except
        Caption:='Result can not be shown but parameters may be entered';
