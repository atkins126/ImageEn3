    ...
    with DecData do
      ...
      begin
        ...
        begin
          ...
          CurrBuf := 1;
          px := pbyte(int64(DWORD(fData)) + PosY * Width + CurrBuf - 1);
        end;
      end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Datap := pbyte(int64(DWORD(Data)) + (y * iWidth));
    end;
    result := Datap^;
    inc(Datap);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      px := pbyte(int64(DWORD(data)) + cury * Width);
    end;
  end;
end;
...
begin
  ...
  i := hsize - 16;
  repeat
    pinteger(int64(DWORD(htab_p)) - 64)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 60)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 56)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 52)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 48)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 44)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 40)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 36)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 32)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 28)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 24)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 20)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 16)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 12)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 8)^ := -1;
    pinteger(int64(DWORD(htab_p)) - 4)^ := -1;
    dec(htab_p, 16);
    dec(i, 16);
  until not (i >= 0);
  inc(i, 16);
