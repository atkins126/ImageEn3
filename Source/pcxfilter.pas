...
begin
  ...
  try
    ...
    fs.read(im^, fsDim - sizeof(TPcxHeader)); // re-read all (also palette)
    impos := 0;
    // set IOParams
    with IOParams do
    begin
    ...
    begin
      ...
      getmem(rowbuf, ph.Bytes_Per_Line * ph.Colour_Planes * 2 + 32); // double size to workaround an old bug
